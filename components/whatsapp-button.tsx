  ...
  if (!phone) {
    return (
      <div style={{ display: 'inline-flex', alignItems: 'center', gap: '4px', marginLeft: '8px' }}>
        <span
          className="whatsapp-button disabled"
          title="Numéro de téléphone manquant pour ce membre"
          style={{
            display: 'inline-flex',
            alignItems: 'center',
  ...
  return (
    <div style={{ display: 'inline-flex', alignItems: 'center', gap: '4px', marginLeft: '8px' }}>
      <a
        ...
        title={msgList.length > 1 ? "Envoyer un message WhatsApp (Rappel 1)" : "Envoyer un message WhatsApp"}
        style={{
          display: 'inline-flex',
          alignItems: 'center',
          justifyContent: 'center',
      ...
      {msgList.length > 1 && msgList.slice(1).map((msg, idx) => (
        <a
          key={idx}
          href={getUrl(msg)}
          target="_blank"
          rel="noopener noreferrer"
          title={`Envoyer un message WhatsApp (Rappel ${idx + 2})`}
          style={{
            display: 'inline-flex',
            alignItems: 'center',
            justifyContent: 'center',
