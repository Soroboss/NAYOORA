...
export default async function MemberChatPage() {
  ...
  return (
    <div className="member-chat-page">
      <header><p className="eyebrow">Votre organisation</p><h1>Chat interne</h1><p>Échangez directement et en toute confidentialité avec les autres membres.</p></header>
