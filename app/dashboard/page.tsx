...
export default async function DashboardPage() {
  ...
  const linkFor = (item: string) => ({
    ...
    "Prêts": "/dashboard/finance",
    "Solidarité": "/dashboard/finance",
    "Mobile Money": "/dashboard/finance",
    ...
    "Ventes": "/dashboard/cooperative?tab=harvests",
    "Intrants": "/dashboard/cooperative?tab=inputs",
    "Syndicat": "/dashboard/political",
    "Secteurs": "/dashboard/political",
    "Revendications": "/dashboard/political",
    "Terrain": "/dashboard/political",
