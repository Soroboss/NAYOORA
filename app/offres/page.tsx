...
export default async function OffersPage() {
  ...
  return <main className="offers-page">
    ...
    <p className="offers-reassurance">Aucune carte bancaire requise. L’offre Gratuit est immédiate ; les offres payantes sont activées après confirmation Wave ou Orange Money.</p>
  </main>;
}
